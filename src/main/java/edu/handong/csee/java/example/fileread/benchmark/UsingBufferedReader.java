...
public class UsingBufferedReader {
    public static void main(String[] args) throws IOException {
    	File inputFile1MB = new File(args[0]);
    	File inputFile10MB = new File(args[1]);
        ...
        BufferedReader inputStream= new BufferedReader(new FileReader(inputFile1MB));
        ...
        BufferedReader inputStream2= new BufferedReader(new FileReader(inputFile10MB));
